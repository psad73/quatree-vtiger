...
<html>
    ...
    <body marginheight="0" marginwidth="0" leftmargin="0" topmargin="0" style="text-align:center;" onLoad="JavaScript:window.print()">
        <div style="text-align: left; width: 80%; padding-top: 25px; margin: auto;"><img src="https://support.quatree.pl/vtigercrm/test/logo/Logo_quatree_semitransparent_bk150x40.png"></div>
        ...
        <div style="text-align: left; width: 80%; padding-top: 25px; margin: auto; font-size: 10px;">QUATREE Sp. z o.o., pl. I. Gugulskiego 1, 02-661 Warszawa, KRS: 0000538181, REGON: 360622441, VAT ID: PL7010459330</div>
    </body>
    <script>
        {literal}
