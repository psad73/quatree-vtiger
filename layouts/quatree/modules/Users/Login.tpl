...
{strip}
	<style>
		body {
			background: url(layouts/v7/skins/images/quatree_crm_logon.jpg);
	...
	<div class="col-lg-12">
		<div class="col-lg-4 col-lg-offset-4">
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="test/logo/Logo_quatree_transparent_bk.png">
				<p align="center">SYSTEM CRM</p>
				<p>&nbsp;</p>
				<div>
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							...
							<span class="bar"></span>
							<label>Username / Użytkownik</label>
						</div>
						<div class="group">
							<input id="password" type="password" name="password" placeholder="Password">
							<span class="bar"></span>
							<label>Password / Hasło</label>
						</div>
						<div class="group">
							<button type="submit" class="button buttonBlue">Sign in / Zaloguj</button><br>
							<a class="forgotPasswordLink" style="color: #15c;">forgot password? / zapomniane hasło?</a>
						</div>
					</form>
				</div>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						...
						<div class="group">
							<button type="submit" class="button buttonBlue forgot-submit-btn">Submit / Zgłoś</button><br>
							<span>Please enter details and submit<a class="forgotPasswordLink pull-right" style="color: #15c;">Back / Cofnij</a></span>
						</div>
					</form>
				</div>
			</div>
